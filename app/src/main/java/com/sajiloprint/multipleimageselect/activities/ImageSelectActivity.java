package com.sajiloprint.multipleimageselect.activities;
...
import com.sajiloprint.multipleimageselect.adapters.CustomImageSelectAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                System.out.println("Constant limit" + Constants.limit);
...
//                        Intent intent = new Intent(ImageSelectActivity.this, AddSubCard.class);
